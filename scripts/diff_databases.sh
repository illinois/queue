...
mysqldbcompare --server1="queue@localhost" --server2="queue@localhost" --run-all-tests --changes-for=server2 --character-set=utf8mb4_general_ci queue_sequelize:queue_migrations
EXIT_CODE=$?
