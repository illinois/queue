...
## [Next]
* Fix autocomplete not working for non-admins by turning it off for them. ([@andrewstec](https://github.com/andrewstec) in [#314](https://github.com/illinois/queue/pull/314))
